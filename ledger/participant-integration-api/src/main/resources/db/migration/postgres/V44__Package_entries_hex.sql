...
ALTER TABLE package_entries
    DROP CONSTRAINT package_entries_pkey;
ALTER TABLE package_entries
    ADD COLUMN ledger_offset_hex varchar;
UPDATE package_entries
set ledger_offset_hex = encode(ledger_offset, 'hex');
ALTER TABLE package_entries
    ALTER COLUMN ledger_offset_hex SET not null;
ALTER TABLE package_entries
